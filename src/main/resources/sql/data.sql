...
INSERT INTO coach (firstname, patronymic, lastname, birth_date, phone, email, specialization, description, image,gym_id)
VALUES ('Иван', 'Иванович', 'Иванов', '01.01.1991',
        '+79173157777', 'ivanov_admin@gmail.com', 'фитнес – менеджер',
        'Инструктор групповых программ HOT IRON, CYCLING. Здоровый человек – счастливый человек!', NULL,1),
       ('Иван', 'Иванович', 'Иванов', '01.01.1991',
...
INSERT INTO gym (address, name, email, phone, working_hours_on_weekdays, working_hours_on_weekends, inst_link, tg_link,
                 vk_link)
VALUES ('Политехническая',
        'СТАРТ.ПОЛИТЕХ',
        'start@mail.ru',
        '+78452000000',
        '8:00-21:00',
